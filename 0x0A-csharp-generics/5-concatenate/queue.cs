...
class Queue<T>
{
    ...
    /// <summary>
    /// Method Print to print the queue starting from the head.
    /// If the queue is empty write 'Queue is emtpy' to console.
    /// </summary>
    public void Print()
    {
        if (this.head == null)
    ...
    /// <summary>
    /// Method Concatenate to concatenate all values in the queue only if the queue
    /// is type String or Char. If queue is empty, print 'Queue is empty' and return null.
    /// If queue is not type String or Char, print 'Concatenate() is for a queue
    ///  of Strings or Chars only' to console and return null.
    /// </summary>
    public string Concatenate()
    {
        ...
        else if (this.CheckType() == typeof(string) || this.CheckType() == typeof(char))
        {
            string result = "";
            Node temp = this.head;
            while (temp != null)
